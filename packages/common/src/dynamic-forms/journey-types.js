...
exports.JOURNEY_TYPES = Object.freeze({
	...
	S78_PART_1_APPEAL_FORM: {
		id: 's78-appeal-form-part-1',
		type: exports.JOURNEY_TYPE.appealForm,
		userType: APPEAL_USER_ROLES.APPELLANT,
		caseType: CASE_TYPES.S78.processCode
	},
	...
	S78_QUESTIONNAIRE_PART_1: {
		id: 's78-questionnaire-part-1',
		type: exports.JOURNEY_TYPE.questionnaire,
		userType: LPA_USER_ROLE,
		caseType: CASE_TYPES.S78.processCode
	},
	...
	ENFORCEMENT_APPEAL_FORM: {
		id: 'enforcement-appeal-form',
		type: exports.JOURNEY_TYPE.appealForm,
		userType: APPEAL_USER_ROLES.APPELLANT,
		caseType: CASE_TYPES.ENFORCEMENT.processCode
	},
	ENFORCEMENT_QUESTIONNAIRE: {
		id: 'enforcement-questionnaire',
		type: exports.JOURNEY_TYPE.questionnaire,
		userType: LPA_USER_ROLE,
		caseType: CASE_TYPES.ENFORCEMENT.processCode
	},
