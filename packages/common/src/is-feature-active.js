/**
 * @param {{ featureFlagging: { endpoint?: string, timeToLiveInMinutes: string | number } }} config
 * @returns {(featureFlagName: string, localPlanningAuthorityCode?: string) => Promise<boolean>}
 */
exports.isFeatureActive = (config) => async (featureFlagName, localPlanningAuthorityCode) => {
