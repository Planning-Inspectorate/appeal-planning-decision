...
} from '../../../../support/householder-planning/appeals-service/appeal-statement-submission/checkNoSensitiveInformation';
import {
  uploadAppealStatementFile
} from '../../../../support/householder-planning/appeals-service/appeal-statement-submission/uploadAppealStatementFile';
import {
  clickSaveAndContinue
} from '../../../../support/householder-planning/appeals-service/appeal-navigation/clickSaveAndContinue';
import {
  uncheckNoSensitiveInformation
} from '../../../../support/householder-planning/appeals-service/appeal-statement-submission/uncheckNoSensitiveInformation';
import {
  confirmAppealStatementFileIsNotUploaded
} from '../../../../support/householder-planning/appeals-service/appeal-statement-submission/confirmAppealStatementFileIsNotUploaded';
import {
  confirmAppealStatementFileIsUploaded
} from '../../../../support/householder-planning/appeals-service/appeal-statement-submission/confirmAppealStatementFileIsUploaded';
import {
  confirmThatNoErrorTriggered
} from '../../../../support/householder-planning/appeals-service/appeal-statement-submission/confirmThatNoErrorTriggered';
import {
  confirmFileContainsSensitiveInformation
} from '../../../../support/householder-planning/appeals-service/appeal-statement-submission/confirmFileContainsSensitiveInformation';
import {
  confirmFileInvalidBecauseWrongFileType
} from '../../../../support/householder-planning/appeals-service/appeal-statement-submission/confirmFileInvalidBecauseWrongFileType';
import {
  confirmFileInvalidBecauseExceedsSizeLimit
} from '../../../../support/householder-planning/appeals-service/appeal-statement-submission/confirmFileInvalidBecauseExceedsSizeLimit';
import {
  confirmFileUploadIsRequested
} from '../../../../support/householder-planning/appeals-service/appeal-statement-submission/confirmFileUploadIsRequested';
import {goToAppealsPage} from '../../../../support/common/go-to-page/goToAppealsPage';
import {pageURLAppeal} from '../../../common/householder-planning/appeals-service/pageURLAppeal';
import {appealStatement} from "../../../../support/householder-planning/appeals-service/page-objects/task-list-po";
...
Given('user submits an appeal statement file {string} confirming that it {string} contain sensitive information',
