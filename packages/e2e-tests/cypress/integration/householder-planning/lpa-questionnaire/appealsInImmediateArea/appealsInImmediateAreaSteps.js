...
import { goToTaskListPage } from '../../../../support/householder-planning/lpa-questionnaire/appeals-questionnaire-tasklist/goToTaskListPage';
...
Then('the user is shown the error message {string}', (errorMessage) => {
	errorMessage === 'Select yes if there are other appeals still being considered'
		? validateErrorMessage(errorMessage, '[data-cy="adjacent-appeals-error"]', 'adjacent-appeals')
