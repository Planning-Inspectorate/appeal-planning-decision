...
Given(
	'LPA Planning Officer has not added any data to the interested parties application question',
	() => {
...
Then(
	'LPA Planning Officer is presented with the ability to upload the interested parties application',
	() => {
		verifyPage(page.url);
