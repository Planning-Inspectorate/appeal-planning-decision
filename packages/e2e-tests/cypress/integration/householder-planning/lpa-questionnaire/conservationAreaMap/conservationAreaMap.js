...
const page = {
	...
	title:
		'Conservation area map and guidance - Appeal Questionnaire - Appeal a householder planning decision - GOV.UK',
...
Then(
	'conservation area map question heading is shown and the uploaded file name should be displayed',
	() => {
