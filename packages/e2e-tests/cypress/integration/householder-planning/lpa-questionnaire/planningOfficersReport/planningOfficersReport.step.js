...
Then(
	"LPA Planning Officer is presented with the ability to upload the Planning Officer's report",
	() => {
		verifyPage(page.url);
...
Then(
	"Upload the Planning Officer's report heading and the uploaded file name should be displayed",
	() => {
