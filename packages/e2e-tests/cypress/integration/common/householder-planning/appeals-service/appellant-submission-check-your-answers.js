...
Then('the appeal information is presented', () => {
	...
	confirmCheckYourAnswersDisplayItem('[data-cy="upload-decision"]', 'appeal-statement-valid.doc');
	confirmCheckYourAnswersDisplayItem('[data-cy="appeal-statement"]', 'appeal-statement-valid.doc');
	confirmCheckYourAnswersDisplayItem(
...
Then('the updated values for About the original planning application section are displayed', () => {
	...
	confirmCheckYourAnswersDisplayItem('[data-cy="upload-decision"]', 'appeal-statement-valid.pdf');
});
...
Then('the updated values for About your appeal section are displayed', () => {
	confirmCheckYourAnswersDisplayItem('[data-cy="appeal-statement"]', 'appeal-statement-valid.png');
	confirmCheckYourAnswersDisplayItem(
		'[data-cy="supporting-documents-no-files"]',
		'No files uploaded'
	);
