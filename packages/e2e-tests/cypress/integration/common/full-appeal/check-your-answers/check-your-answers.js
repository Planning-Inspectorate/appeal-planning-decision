...
Given(
	'appellant uploads documents for appeal for plans and drawings {string} and supporting documents {string} and status is {string}',
	(plans_and_drawings, supporting_documents, progress) => {
...
Then(
	'appellant is displayed answers for appeal site for {string}, {string}, {string}, {string}, {string}, {string}, {string} and {string}',
	(
		own_land,
		own_some_land,
		knowTheOwners,
...
Then(
	'appellant is displayed answers for planning application for {string}',
...
Then(
	'appellant is displayed answers for appeal for {string} and {string}',
	(plans_and_drawings, supporting_documents) => {
