...
Given(
	'an appellant is on the is your appeal about any of the following page for {string}',
	(application_type) => {
...
Then(
	'an appellants gets routed to shutter page which notifies them to use a different service',
	() => {
