Feature: Appellant selects the site
  ...
  Scenario Outline: AC03 Back Link
    ...
    Examples:
      ...
      | Full planning                      | what type of planning application did you make |
      | Outline planning                   | what type of planning application did you make |
      | Prior approval                     | Prior approval existing home                   |
      | Reserved matters                   | what type of planning application did you make |
      | Removal or variation of conditions | what type of planning application did you make |
