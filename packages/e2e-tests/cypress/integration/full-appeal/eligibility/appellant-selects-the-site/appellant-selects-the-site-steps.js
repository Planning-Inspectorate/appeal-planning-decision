...
import { selectSiteOption } from '../../../../support/full-appeal/eligibility/appellant-selects-the-site/select-site-option';
import { getBackLink, getContinueButton, getErrorMessageSummary } from '../../../../support/common-page-objects/common-po';
import { verifyDeselectSiteOption } from '../../../../support/full-appeal/eligibility/appellant-selects-the-site/verify-deselect-site-option';
import {
  getNoneOfTheseOption,
  getSelectSiteErrorMessage,
} from '../../../../support/full-appeal/eligibility/page-objects/appellant-selects-the-site-po';
