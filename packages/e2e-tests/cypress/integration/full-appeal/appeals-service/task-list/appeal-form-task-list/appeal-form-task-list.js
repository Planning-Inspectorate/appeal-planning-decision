...
When("they select 'Yes, the planning application was made in my name' and click Continue button", () => {
...
When("they use 'Back' link to navigate back to the Task list page from 'Own all the land' page", () => {
...
When("they use 'Back' link to navigate back to the Task list page from 'Prefer a hearing' page", () => {
  cy.url().should('contain', whyHearingUrl);
  getBackLink().click();
  cy.url().should('contain', howDecideAppealUrl);
  getBackLink().click();
});
Then("status of the 'Tell us how you would prefer us to decide your appeal' section should be {string}", (progress) => {
  cy.url().should('contain', url);
  statusAppealDecisionSection().should('contain.text',progress );
});
...
When("they use 'Back' link to navigate back to the Task list page from 'planning application number' page", () => {
