...
Then(
	"status of the 'Upload documents from your planning application' section should be {string}",
	(progress) => {
		cy.url().should('contain', url);
		statusUploadDocsFromPlanningApplication().should('contain.text', progress);
	}
...
When(
	"they click on 'Upload documents for your appeal' section and are on the 'Your appeal statement' page",
	() => {
...
When(
	"they use 'Back' link to navigate back to the Task list page from 'New plans or drawings' page",
	() => {
