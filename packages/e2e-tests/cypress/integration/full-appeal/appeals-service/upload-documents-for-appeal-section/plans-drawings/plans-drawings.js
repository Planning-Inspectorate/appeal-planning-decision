...
Given(
	"an Appellant or Agent is on the 'Do you have any new plans or drawings that support your appeal' page",
	() => {
		appealDocumentsSectionLink().click();
		getFileUploadButton().attachFile(filename);
		checkboxConfirmSensitiveInfo().click();
...
Then(
	"they are presented with the 'Your appeal statement' page with the uploaded file is displayed and confirm checkbox selected",
	() => {
