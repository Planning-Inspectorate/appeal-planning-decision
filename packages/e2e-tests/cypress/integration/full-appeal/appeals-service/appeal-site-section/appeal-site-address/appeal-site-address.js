...
const textPageText =
	'The appeal site is the area of property or land that your planning application relates to.';
...
And('the appellant is informed that {string}', (reason) => {
	switch (reason) {
		case 'Enter the building and street':
			verifyErrorMessage(reason, siteAddressLineOneErrorMessage, getErrorMessageSummary);
			break;
		...
		case 'The second line of the building and street must be 60 characters or fewer':
			verifyErrorMessage(reason, siteAddressLineTwoErrorMessage, getErrorMessageSummary);
			break;
		case 'Town or City must be 60 characters or fewer':
			verifyErrorMessage(reason, siteTownCityErrorMessage, getErrorMessageSummary);
			break;
		case 'County must be 60 characters or fewer':
			verifyErrorMessage(reason, siteCountyErrorMessage, getErrorMessageSummary);
			break;
		case 'Enter the postcode':
			verifyErrorMessage(reason, sitePostcodeErrorMessage, getErrorMessageSummary);
			break;
