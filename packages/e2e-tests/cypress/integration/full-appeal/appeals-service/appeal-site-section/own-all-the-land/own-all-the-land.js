...
import { errorMessageOwnAllLand } from '../../../../../support/full-appeal/appeals-service/page-objects/own-the-land-po';
...
const pageTitle =
	'Do you own all the land involved in the appeal? - Appeal a planning decision - GOV.UK';
...
Then(
	"the user is taken to the next page 'Is the appeal site part of an agricultural holding'",
	() => {
