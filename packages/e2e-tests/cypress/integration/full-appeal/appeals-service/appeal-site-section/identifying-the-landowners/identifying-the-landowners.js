...
import {
	...
	listItem1IdentifyingTheOwners,
	listItem2IdentifyingTheOwners,
	selectNo,
	selectSomeOf,
	statementTitle
...
const checkBoxLabelKnowSome =
	"I confirm that I've attempted to identify all the landowners, but have not been successful.";
const checkBoxLabelNoIDoNotKnow =
	"I confirm that I've taken all reasonable steps to identify the landowners";
...
Given(
	"an Appellant or Agent is on the 'Do you know who owns the land involved in the appeal' page",
	() => {
...
Then(
	"'Identifying the landowners' page is displayed with text 'Have you taken all reasonable steps to identify the landowners?'",
	() => {
		cy.url().should('contain', url);
...
Given(
	"an Appellant or Agent is on the 'Identifying the landowners' page for the option 'No, I do not know who owns any of the land'",
	() => {
		pageMethodsKnowTheOwners();
		selectNo().click();
		getSaveAndContinueButton().click();
...
Given(
	"a statement 'Confirm that you have attempted to identify the landowners' is displayed",
	() => {
...
Then(
	"they are presented with the 'Do you know who owns the land involved in the appeal' page and 'No' option is selected",
	() => {
		cy.url().should('contain', knowTheOwnersUrl);
...
Then(
	"they are presented with the 'Do you know who owns the land involved in the appeal' page and 'I know' option is selected",
	() => {
		cy.url().should('contain', knowTheOwnersUrl);
