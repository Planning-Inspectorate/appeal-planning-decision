...
const pageTitle =
	'Are you a tenant of the agricultural holding? - Appeal a planning decision - GOV.UK';
...
Given(
	"an appellant or agent is on the 'Are you a tenant of the agricultural holding?' page",
	() => {
		aboutAppealSiteSectionLink().click();
		cy.url().should('contain', siteAddressUrl);
		provideAddressLine1(addressLine1);
