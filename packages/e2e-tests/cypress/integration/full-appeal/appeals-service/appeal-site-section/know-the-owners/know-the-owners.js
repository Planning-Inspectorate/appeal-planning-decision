...
const pageTitleRestOfLand =
	'Do you know who owns the rest of the land involved in the appeal? - Appeal a planning decision - GOV.UK';
const pageTitleOwnTheLand =
	'Do you know who owns the land involved in the appeal? - Appeal a planning decision - GOV.UK';
...
Given(
	"an appellant or agent is on the 'Do you own some of the land involved in the appeal' page",
	() => {
		callMethodsTillSomeOfLandUrl();
	}
);
Then(
	"'Do you know who owns the rest of the land involved in the appeal?' page is displayed",
	() => {
