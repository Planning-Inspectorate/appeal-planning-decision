Feature: As an Agent representing an applicant
  ...
  Scenario: 6. Navigate from What is the applicants name page back to Task List
    Given an agent is on the 'What is the applicant’s name' page
    When they click on the 'Back' link
    Then an Appellant or Agent is on the 'Was the original planning application made in your name?'
