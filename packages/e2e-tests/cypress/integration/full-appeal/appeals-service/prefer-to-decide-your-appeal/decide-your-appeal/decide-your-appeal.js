...
const pageTitle =
	'How would you prefer us to decide your appeal? - Appeal a planning decision - GOV.UK';
...
Given(
	"an Appellant or Agent is on the 'How would you prefer us to decide your appeal' page",
	() => {
		linkDecideYourAppeal().click();
		cy.url().should('include', Url);
