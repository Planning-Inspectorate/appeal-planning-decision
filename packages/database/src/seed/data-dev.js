...
async function createCasesInState(dbClient) {
	...
	const variations = [
		...
		{ type: CASE_TYPES.ENFORCEMENT, process: APPEAL_CASE_PROCEDURE.WRITTEN },
		{ type: CASE_TYPES.ENFORCEMENT, process: APPEAL_CASE_PROCEDURE.HEARING },
		{ type: CASE_TYPES.ENFORCEMENT, process: APPEAL_CASE_PROCEDURE.INQUIRY },
		{ type: CASE_TYPES.ENFORCEMENT_LISTED, process: APPEAL_CASE_PROCEDURE.WRITTEN },
		{ type: CASE_TYPES.ENFORCEMENT_LISTED, process: APPEAL_CASE_PROCEDURE.HEARING },
		{ type: CASE_TYPES.ENFORCEMENT_LISTED, process: APPEAL_CASE_PROCEDURE.INQUIRY },
		{ type: CASE_TYPES.LDC, process: APPEAL_CASE_PROCEDURE.WRITTEN },
		{ type: CASE_TYPES.LDC, process: APPEAL_CASE_PROCEDURE.HEARING },
		{ type: CASE_TYPES.LDC, process: APPEAL_CASE_PROCEDURE.INQUIRY }
	];
