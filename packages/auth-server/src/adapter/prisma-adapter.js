...
export default class PrismaAdapter {
	 ...
	 * @param { () => (Promise<import('@pins/database/src/client/client').Oidc|null>) } query
	 * @returns {Promise<AdapterPayload|undefined>}
	 */
	async #get(query) {
	...
	/**
	 * @param { import('@pins/database/src/client/client').Oidc|null } doc
	 * @returns {boolean}
	 */
	#isValidOidc(doc) {
	 ...
	 * @param { import('@pins/database/src/client/client').Oidc } doc
