...
const store = new Map(); // user store cache, will cache invalidation catch us out?
...
class Account {
	...
	async claims(use, scope, claims, rejected) {
		return {
			...
			//isEnrolled: this.user.isEnrolled
			// isLpaUser: this.user.isLpaUser,
			// isLpaAdmin: this.user.isLpaAdmin,
			// lpaCode: this.user.lpaCode,
			// lpaStatus: this.user.lpaStatus,
