...
describe('controllers/delete-supplementary-document', () => {
  ...
  describe('getDeleteDocument', () => {
    ...
    beforeEach(() => {
      ...
      cancelLink =
        'mock-protocol://mock-host/mock-appeal-id/supplementary-documents/uploaded-documents';
      renderObject = {
        cancelLink,
        fileToDelete,
        appeal: null,
  ...
  describe('postDeleteDocument', () => {
    const baseRedirect = '/mock-appeal-id/supplementary-documents';
    let mockRequest;
    ...
    it('should redirect to add-document as there are no documents left to delete', async () => {
      ...
      expect(res.redirect).toHaveBeenCalledWith(baseRedirect);
    });
