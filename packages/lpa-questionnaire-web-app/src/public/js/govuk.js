...
(function (global, factory) {
          ...
          const defineGetter = function (object, name, fn, configurable) {
            if (Object.defineProperty)
              Object.defineProperty(object, name, {
                configurable: dpSupport === false ? true : !!configurable,
                get: fn,
              });
      ...
      var addProp = function (o, name, attr) {
        defineGetter(
          ...
          function () {
            ...
            const gibberishProperty = `${'__defineGetter__' + 'DEFINE_PROPERTY'}${name}`;
  ...
  Accordion.prototype.initHeaderAttributes = function ($headerWrapper, index) {
    ...
    const $heading = $headerWrapper.querySelector(`.${this.sectionHeadingClass}`);
    const $summary = $headerWrapper.querySelector(`.${this.sectionSummaryClass}`);
  ...
  Header.prototype.handleMenuButtonClick = function () {
    const isVisible = this.$menu.classList.toggle('govuk-header__navigation--open');
