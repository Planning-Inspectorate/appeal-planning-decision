...
const decisionDateController = require('../../../../src/controllers/full-planning/date-decision-due');
...
} = require('../../../../src/validators/full-planning/date-decision-due');

jest.mock('../../../../src/validators/full-planning/date-decision-due');

describe('routes/eligibility/decision-date', () => {
  beforeEach(() => {
    // eslint-disable-next-line global-require
    require('../../../../src/routes/full-planning/date-decision-due');
  });
