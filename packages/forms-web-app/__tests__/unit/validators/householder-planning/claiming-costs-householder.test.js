...
const { rules } = require('../../../../src/validators/householder-planning/claiming-costs-householder');
...
describe('validators/planning-department', () => {
  describe('rules', () => {
    it('is configured with the expected rules', () => {
      ...
      expect(rule.stack[0].message).toEqual('Select yes if your are claiming costs as part of your appeal');
    });
  });
  describe('validator', () => {
    [
      ...
      },
      {
        ...
        expected: (result) => {
          ...
          expect(result.errors[0].msg).toEqual('Select yes if your are claiming costs as part of your appeal');
