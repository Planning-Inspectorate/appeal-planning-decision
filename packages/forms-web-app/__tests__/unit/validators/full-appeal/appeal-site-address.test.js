...
describe('validators/full-appeal/appeal-site-address', () => {
  describe('rules', () => {
    let rules;
    ...
    [
      ...
      },
      {
        ...
        expected: (result) => {
          ...
          expect(result.errors[0].msg).toEqual('Enter the building and street');
        },
      },
      {
        ...
        expected: (result) => {
          expect(result.errors).toHaveLength(1);
          expect(result.errors[0].msg).toEqual('Enter the postcode');
        },
      },
      {
      ...
      },
      {
        ...
        expected: (result) => {
          ...
          expect(result.errors[0].msg).toEqual('Enter the building and street');
          expect(result.errors[1].msg).toEqual('Enter the postcode');
        },
      },
      {
