		...
		it('should re-render template with errors if errors thrown', async () => {
			...
			const errors = {
				'files.file-upload[0]': {
					...
					msg: 'not-valid-mimetype.gif must be a DOC, DOCX, PDF, TIF, JPG, PNG or XLSX',
					param: 'files.file-upload[0]',
					location: 'body'
				},
				'files.file-upload[1]': {
					value: { name: 'also-not-valid-mimetype.webp' },
					msg: 'also-not-valid-mimetype.gif must be a DOC, DOCX, PDF, TIF, JPG, PNG or XLSX',
			...
			const errorSummary = [
				{
					text: 'not-valid-mimetype.gif must be a DOC, DOCX, PDF, TIF, JPG, PNG or XLSX',
					href: '#'
				},
				{
					text: 'also-not-valid-mimetype.webp must be a DOC, DOCX, PDF, TIF, JPG, PNG or XLSX',
					href: '#'
				}
			];
		...
		it('should handle a request containing valid and invalid files', async () => {
			const errors = {
				'files.file-upload[1]': {
					...
					msg: 'error-throwing-file.gif must be a DOC, DOCX, PDF, TIF, JPG, PNG or XLSX',
					param: 'files.file-upload[1]',
					location: 'body'
				}
			};
			...
			const errorSummary = [
				{
					text: 'error-throwing-file.gif must be a DOC, DOCX, PDF, TIF, JPG, PNG or XLSX',
					href: '#'
				}
			];
