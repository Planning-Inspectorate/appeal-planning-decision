...
} = require('../../../../../src/lib/full-planning/views');
...
describe('controllers/full-planning/full-appeal/contact-details', () => {
  let req;
  let res;
  let appeal;
  ...
  describe('postContactDetails', () => {
    ...
    it('should redirect to task list if valid and original appellant', async () => {
      ...
      expect(res.redirect).toHaveBeenCalledWith('/full-appeal/task-list');
    });
  });
});
