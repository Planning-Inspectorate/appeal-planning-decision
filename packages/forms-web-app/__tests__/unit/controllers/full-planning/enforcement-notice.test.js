...
const {
  VIEW: {
    FULL_PLANNING: { ENFORCEMENT_NOTICE: currentPage },
  },
...
describe('controllers/full-planning/enforcement-notice', () => {
  let req;
  let res;
  let appeal;
  ...
  describe('postEnforcementNotice', () => {
    ...
    it('should redirect to `/full-planning/use-a-different-service` if `enforcement-notice` is `yes`', async () => {
      const mockRequest = {
        ...req,
        body: {
    ...
    it('should redirect to `/full-planning/granted-or-refused` if `enforcement-notice` is `no`', async () => {
      const mockRequest = {
        ...req,
        body: {
