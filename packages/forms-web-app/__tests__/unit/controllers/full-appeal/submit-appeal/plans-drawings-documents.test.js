...
describe('controllers/full-appeal/submit-appeal/plans-drawings-documents', () => {
  let req;
  let res;
  let appealData;
  ...
  describe('getPlansDrawingsDocuments', () => {
    it('should call the correct template', () => {
      getPlansDrawingsDocuments(req, res);

      expect(res.render).toHaveBeenCalledTimes(1);
      expect(res.render).toHaveBeenCalledWith(PLANS_DRAWINGS_DOCUMENTS, {
  ...
  describe('postPlansDrawingsDocuments', () => {
    it('should re-render the template with errors if submission validation fails', async () => {
      ...
      await postPlansDrawingsDocuments(req, res);
