...
const mapPlanningApplication = (application) => {
	switch (application) {
		...
		case TYPE_OF_PLANNING_APPLICATION.PERMISSION_IN_PRINCIPLE:
		...
		case TYPE_OF_PLANNING_APPLICATION.ENFORCEMENT_NOTICE:
			return APPEAL_ID.ENFORCEMENT_NOTICE;
		case TYPE_OF_PLANNING_APPLICATION.ENFORCEMENT_LISTED_BUILDING:
			return APPEAL_ID.ENFORCEMENT_LISTED_BUILDING;
