...
describe('validators/before-you-start/application-not-found', () => {
	...
	it('should error when confirm-application-number is invalid value', async () => {
		const req = { body: { 'confirm-application-number': 'invalid' } };
	...
	it('should pass when confirm-application-number is provided', async () => {
		const req = { body: { 'confirm-application-number': 'yes' } };
