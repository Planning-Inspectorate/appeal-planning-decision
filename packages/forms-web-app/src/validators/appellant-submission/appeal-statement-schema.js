  ...
  'appeal-upload': {
    custom: {
      options: async (value, { req, path }) => {
        ...
        if (typeof req.files['appeal-upload'] !== 'undefined') {
          const fileStream = fs.createReadStream(req.files['appeal-upload'].tempFilePath);
          ...
          validMimeType(
            ...
            'Docs is is the wrong file type: The file must be a DOC, DOCX, PDF, TIF, JPG or PNG'
          );
        }
