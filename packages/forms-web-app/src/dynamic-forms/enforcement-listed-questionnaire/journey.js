		...
		new Section('Constraints, designations and other issues', 'constraints')
			...
			.withVariables({
				[QUESTION_VARIABLES.APPEAL_TYPE_WITH_AN_OR_A]:
					mapAppealTypeToDisplayTextWithAnOrA(ENFORCEMENT_LISTED),
				[QUESTION_VARIABLES.APPEAL_TYPE]: mapAppealTypeToDisplayText(ENFORCEMENT_LISTED)
			})
...
const baseEnforcementListedUrl = '/manage-appeals/questionnaire';
...
const makeBaseUrl = (response) =>
	`${baseEnforcementListedUrl}/${encodeURIComponent(response.referenceId)}`;

/** @type {JourneyParameters} */
const params = {
	journeyId: JOURNEY_TYPES.ENFORCEMENT_LISTED_QUESTIONNAIRE.id,
	makeSections,
...
module.exports = { ...params, baseEnforcementListedUrl };
