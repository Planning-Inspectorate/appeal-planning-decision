...
export class NotifyInteraction {
    static getAppealSubmittedEmailForAppellantInteraction(appeal: any, appellantName: string, lpaName: string): Interaction{
    ...
    static getAppealSubmittedEmailForLpaInteraction(appeal: any, lpaName: string, lpaEmail: string): Interaction {
