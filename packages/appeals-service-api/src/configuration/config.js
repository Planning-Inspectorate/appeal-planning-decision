				...
				APPEAL_SUBMISSION: {
					V1_HORIZON: {
						appellantAppealSubmissionInitialConfirmation:
							process.env.SRV_NOTIFY_V1_INITIAL_CONFIRMATION_EMAIL_TO_APPELLANT_TEMPLATE_ID,
						appellantAppealSubmissionFollowUpConfirmation:
							process.env.SRV_NOTIFY_V1_FOLLOW_UP_CONFIRMATION_EMAIL_TO_APPELLANT_TEMPLATE_ID
					},
					V2_BACK_OFFICE: {
						appellantAppealSubmissionInitialConfirmation:
							process.env.SRV_NOTIFY_V2_INITIAL_CONFIRMATION_EMAIL_TO_APPELLANT_TEMPLATE_ID,
						appellantAppealSubmissionFollowUpConfirmation:
							process.env.SRV_NOTIFY_V2_FOLLOW_UP_CONFIRMATION_EMAIL_TO_APPELLANT_TEMPLATE_ID
					}
				},
