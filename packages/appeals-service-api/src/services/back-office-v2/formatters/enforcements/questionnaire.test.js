...
describe('formatter', () => {
	...
	const enforcementAnswers = {
		...
		singleHouse: true,
		trunkRoad: 'yes',
		trunkRoad_trunkRoadDetails: 'blah balh',
		crownLand: true,
		stopNotice: false,
	...
	it('should format the Enforcement data correctly', async () => {
		...
		expect(result).toEqual({
			casedata: {
				...
				siteAreaSquareMetres: Number(enforcementAnswers.siteAreaSquareMetres),
				...
				affectedTrunkRoadName: enforcementAnswers.trunkRoad_trunkRoadDetails,
				article4AffectedDevelopmentRights: enforcementAnswers.developmentRightsRemoved,
				changeOfUseMineralExtraction: enforcementAnswers.mineralExtractionMaterials,
				changeOfUseMineralStorage: enforcementAnswers.storeMinerals,
				changeOfUseRefuseOrWaste: enforcementAnswers.refuseWasteMaterials,
				floorSpaceCreatedByBreachInSquareMetres:
					enforcementAnswers.createFloorSpace_createFloorSpaceSquareMetres,
				areaOfAllegedBreachInSquareMetres:
					enforcementAnswers.allegedBreachArea_allegedBreachAreaSquareMetres,
				isSiteOnCrownLand: enforcementAnswers.crownLand,
				noticeRelatesToBuildingEngineeringMiningOther: enforcementAnswers.otherOperations,
				relatesToBuildingSingleDwellingHouse: enforcementAnswers.singleHouse,
				relatesToBuildingWithAgriculturalPurpose: enforcementAnswers.agriculturalPurposes,
				relatesToErectionOfBuildingOrBuildings: enforcementAnswers.createBuilding
			},
			documents: [1]
		});
	});
