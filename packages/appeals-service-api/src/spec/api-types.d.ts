...
/// last generated 2026-06-09T13:00:41.487Z
...
/** details about an advert on a case */
export interface AdvertDetail {
	/**
	 * unique identifier for the advert detail
	 * @format uuid
	 */
	id: string;
	/** type of advert */
	advertType:
		...
		| 'Other'
		| null;
	/** is the advert in position */
	isAdvertInPosition: boolean;
	/** is the site on highway land */
	isSiteOnHighwayLand: boolean;
	/** the case reference this advert detail is associated with */
...
export interface AppealCase {
	...
	/** The grid reference easting for the appeal site */
	siteGridReferenceEasting?: string;
	/** The grid reference northing for the appeal site */
	...
	/** The reason for the appeal, as provided by the appellant */
	reasonForAppealAppellant?: string | null;
	/** Whether there have been significant changes since the application */
	anySignificantChanges?: string | null;
	/** Local plan significant changes details */
	anySignificantChanges_localPlanSignificantChanges?: string | null;
	/** National policy significant changes details */
	anySignificantChanges_nationalPolicySignificantChanges?: string | null;
	/** Court judgement significant changes details */
	anySignificantChanges_courtJudgementSignificantChanges?: string | null;
	/** Other significant changes details */
	...
	/** Appellant's interest in the appeal site */
	ownerOccupancyStatus?: string;
	/** Whether the appellant has permission to use the land, if required */
	occupancyConditionsMet?: boolean;
	/** Did the appellant make an application */
	applicationMadeAndFeePaid?: boolean;
	/** Did the appellant make a retrospective planning application */
	retrospectiveApplication?: boolean;
	/** Did the appellant pay a ground (a) fee */
	groundAFeePaid?: boolean;
	/** was previous planning permission granted */
	previousPlanningPermissionGranted?: boolean;
	/** @format date-time */
	issueDateOfEnforcementNotice?: string;
	/** @format date-time */
	effectiveDateOfEnforcementNotice?: string;
	/** If the LPA issued a decision in relation to an application, did the appellant appeal it */
	didAppellantAppealLpaDecision?: boolean;
	/** @format date-time */
	dateLpaDecisionDue?: string;
	/** @format date-time */
	dateLpaDecisionReceived?: string;
	/** the reference number on the enforcement notice */
	enforcementReference?: string;
	/** a description of the alleged breach set out in the enforcement notice */
	descriptionOfAllegedBreach?: string;
	/** whether any application covered all or part of the development */
	applicationPartOrWholeDevelopment?: string;
	/**
	 * if applicable, the date on which the appellant contacted the planning inspectorate before the enforcement effective date
	 * @format date-time
	 */
	...
	AdvertDetails?: AdvertDetail[];
	EnforcementAppealGroundsDetails?: EnforcementAppealGroundsDetails[];
...
export interface Appeal {
	...
	leadAppellantSubmissionId?: string | null;
	/** An appeal case from the Back Office */
...
export interface AppellantFinalCommentSubmission {
	...
	appellantFinalCommentDocuments?: boolean | null;
	appellantHowSubmitFinalComment?: string | null;
...
export interface AppellantSubmission {
	...
	lawfulDevelopmentCertificateType?: string | null;
	isAppellant?: boolean;
	...
	statusPlanningObligation?: string;
	planningObligationSubmitted?: boolean | null;
	applicationReference?: string;
	...
	uploadGroundASupporting?: boolean | null;
	uploadGroundBSupporting?: boolean | null;
	uploadGroundCSupporting?: boolean | null;
	uploadGroundDSupporting?: boolean | null;
	uploadGroundESupporting?: boolean | null;
	uploadGroundFSupporting?: boolean | null;
	uploadGroundGSupporting?: boolean | null;
	uploadGroundHSupporting?: boolean | null;
	uploadGroundISupporting?: boolean | null;
	uploadGroundJSupporting?: boolean | null;
	uploadGroundKSupporting?: boolean | null;
	SubmissionDocumentUpload?: object[];
	siteAddress?: boolean;
	siteGridReferenceEasting?: string;
	siteGridReferenceNorthing?: string;
	siteAddressIsContactAddress?: boolean;
	...
	addNamedIndividual?: boolean;
	selectedNamedIndividualId?: string;
	enforcementOrganisationName?: string;
	interestInAppealLand?: string;
	interestInAppealLandDetails?: string;
	hasPermissionToUseLand?: boolean;
	allegedBreachDescription?: string;
	/** a legacy field */
	applicationMadeAndFeePaid?: boolean;
	/** a legacy field */
	uploadApplicationReceipt?: boolean | null;
	retrospectiveApplication?: boolean;
	groundAFeePaid?: boolean;
	uploadGroundAFeeReceipt?: boolean | null;
	applicationPartOrWholeDevelopment?: string;
	applicationDecisionAppealed?: boolean;
	/** @format date-time */
	applicationDecisionDueDate?: string;
	/** @format date-time */
	appealDecisionDate?: string;
	uploadPriorCorrespondence?: boolean | null;
	uploadEnforcementNotice?: boolean | null;
	uploadEnforcementNoticePlan?: boolean | null;
	SubmissionAddress?: SubmissionAddress[];
	SubmissionListedBuilding?: object[];
	SubmissionIndividual?: SubmissionIndividual[];
	SubmissionAppealGround?: SubmissionAppealGround[];
}
...
/** details about an appeal ground */
export interface EnforcementAppealGroundsDetails {
	/**
	 * unique identifier for the appeal ground details
	 * @format uuid
	 */
	id: string;
	/** letter of appeal ground */
	appealGroundLetter?: 'a' | 'b' | 'c' | 'd' | 'e' | 'f' | 'g' | 'h' | 'i' | 'j' | 'k' | null;
	/**
	 * start dat for appeal ground
	 * @format date-time
	 */
	groundForAppealStartDate?: string;
	/** facts supporting the pleading of the appeal ground */
	groundFacts?: string;
	/** the case reference this advert detail is associated with */
	caseReference: string;
}
...
export interface LPAFinalCommentSubmission {
	...
	lpaFinalCommentDocuments?: boolean | null;
	lpaHowSubmitFinalComment?: string | null;
...
export interface LPAQuestionnaireSubmission {
	...
	section3aGrant?: boolean | null;
	isSiteInAreaOfSpecialControlAdverts?: boolean | null;
	wasApplicationRefusedDueToHighwayOrTraffic?: boolean | null;
	didAppellantSubmitCompletePhotosAndPlans?: boolean | null;
	listOfPeopleSentEnforcementNotice?: boolean | null;
	otherOperations?: boolean | null;
	siteAreaSquareMetres?: number | null;
	allegedBreachArea?: boolean | null;
	allegedBreachAreaSquareMetres?: number | null;
	createFloorSpace?: boolean | null;
	createFloorSpaceSquareMetres?: number | null;
	refuseWasteMaterials?: boolean | null;
	mineralExtractionMaterials?: boolean | null;
	storeMinerals?: boolean | null;
	createBuilding?: boolean | null;
	agriculturalPurposes?: boolean | null;
	singleHouse?: boolean | null;
	trunkRoad?: string | null;
	trunkRoadDetails?: string | null;
	crownLand?: boolean | null;
	stopNotice?: boolean | null;
	stopNoticeUpload?: boolean | null;
	developmentRights?: boolean | null;
	developmentRightsUpload?: boolean | null;
	developmentRightsRemoved?: string | null;
	...
	previousPlanningPermissionUpload?: boolean | null;
	noticeDateApplication?: boolean | null;
	noticeDateApplicationUpload?: boolean | null;
	noticePlanUpload?: boolean | null;
	planningContraventionNotice?: boolean | null;
	planningContraventionNoticeUpload?: boolean | null;
	appellantSubmittedEnvironmentalStatement?: boolean | null;
	designAccessStatement?: boolean | null;
	uploadDesignAccessStatement?: boolean | null;
	plansAndDrawings?: boolean | null;
	plansAndDrawingsUpload?: boolean | null;
	additionalDocuments?: boolean | null;
	uploadAdditionalDocuments?: boolean | null;
...
/** An appeal ground related to a submission */
export interface SubmissionAppealGround {
	/**
	 * identifier for the submission appeal ground
	 * @format uuid
	 */
	id: string;
	/**
	 * appeal submission id this appeal ground is associated with
	 * @format uuid
	 */
	appellantSubmissionId: string;
	/** name of the appeal ground, 'a'-'g' for enforcement notice appeals */
	groundName: string;
	/** submitted facts in relation to the appeal */
	facts?: string;
	/** whether documents in support of this appeal ground are submitted by an appellant */
	addSupportingDocuments?: boolean;
}
...
/** The named individual (other than the appellant/agent) related to a submission */
export interface SubmissionIndividual {
	/**
	 * identifier for the submission individual
	 * @format uuid
	 */
	id: string;
	/**
	 * appeal submission id this individual is associated with
	 * @format uuid
	 */
	appellantSubmissionId: string;
	/** first name of the named individual */
	firstName: string;
	/** last name of the named individual */
	lastName: string;
	/** which question this named individual is associated with for the submission */
	fieldName: string;
	/** the individual's interest in the land covered by the appeal */
	interestInAppealLand?: string;
	/** further details of individual's interest in land covered by appeal */
	interestInAppealLandDescription?: string;
	/** if interest is 'other', does individual have permission to use land */
	hasPermissionToUseLand?: boolean;
}
