...
module.exports = ({
	 ...
	 * @returns {Promise<import('@pins/database/src/client/client').AppellantSubmission & { AppellantSubmission: import('@pins/database/src/client/client').AppellantSubmission })}>}
	 */
