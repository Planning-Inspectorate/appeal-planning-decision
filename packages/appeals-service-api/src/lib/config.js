...
module.exports = {
  ...
  messageQueue: {
    ...
    sqlAppealsPublisher: {
      connection: {
        host: process.env.SQL_APPEALS_PUBLISHER_HOST,
        hostname: process.env.SQL_APPEALS_PUBLISHER_HOSTNAME,
        reconnect_limit: Number(process.env.SQL_APPEALS_PUBLISHER_RECONNECT_LIMIT || 1),
        password: process.env.SQL_APPEALS_PUBLISHER_PASSWORD,
        port: Number(process.env.SQL_APPEALS_PUBLISHER_PORT || 5672),
        reconnect: process.env.SQL_APPEALS_PUBLISHER_ATTEMPT_RECONNECTION !== 'false',
        transport: process.env.SQL_APPEALS_PUBLISHER_TRANSPORT,
        username: process.env.SQL_APPEALS_PUBLISHER_USERNAME,
      },
      queue: process.env.SQL_APPEALS_PUBLISHER_QUEUE,
    },
  },
  server: {
