...
describe('listed building Questionnaire Test Cases', { tags: '@S20-LPAQ-Submission' } , () => {
        ...
        listedBuildingQuestionnaireTestCases.forEach((context) => {

                it(`
            Should validate Listed Building questionnaire screen, Appeal Type: Listed Building
            ...
            - User selects procedure type${context.appealProcess?.isProcedureType}
             `, () => {
                        questionnaire(context, lpaManageAppealsData, lpaManageAppealsData?.s20AppealType);
                });
        });
});