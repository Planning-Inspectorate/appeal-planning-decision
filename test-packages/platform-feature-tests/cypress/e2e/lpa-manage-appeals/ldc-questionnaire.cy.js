...
import { ldcQuestionnaireTestCases } from "../../helpers/lpaManageAppeals/ldcQuestionnaireData.js";
const { questionnaire } = require('../../support/flows/sections/lpaManageAppeals/questionnaire.js');
const { YourAppealsSelector } = require("../../page-objects/lpa-manage-appeals/your-appeals-selector.js");

describe('Lawful Development Certificate Questionnaire Test Cases', { tags: '@LDC-LPAQ-Submission' }, () => {
        ...
        ldcQuestionnaireTestCases.forEach((context) => {
            ...
            - User selects procedure type${context.appealProcess?.isProcedureType}
             `, () => {
                        questionnaire(context, lpaManageAppealsData, lpaManageAppealsData?.ldcAppealType);
                });
        });
});