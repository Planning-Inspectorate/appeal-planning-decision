...
import { uploadDuplicateFiles, uploadFilesWithWrongFormats } from '../../utils/uploadService';
...
describe('LPA Manage Listed Building Questionnaire validation', () => {
...
describe('Listed Building questionnaire validation', () => {
	const basePage = new BasePage();
	const yourAppealsSelector = new YourAppealsSelector();
	// eslint-disable-next-line no-unused-vars
	const context = listedBuildingQuestionnaireTestCases[0];
	let lpaManageAppealsData;
	let appealId;
	beforeEach(() => {
		cy.fixture('lpaManageAppealsData').then((data) => {
    ...
    cy.get(basePage?._selectors.trgovukTableRow).each(($row) => {
      ...
      if (rowtext.includes(lpaManageAppealsData?.s20AppealType) && rowtext.includes(lpaManageAppealsData?.todoQuestionnaire)) {
        if (counter === 6) {
          cy.wrap($row).within(() => {
            cy.get(basePage?._selectors.trgovukTableCell).contains(lpaManageAppealsData?.s20AppealType).should('be.visible');
            cy.get('a').each(($link) => {
  ...
  it(`Listed Building questionnaire url`, () => {
    cy.url().should('include', `/manage-appeals/questionnaire/${appealId}`);
  });

	it(`Validate Listed Building questionnaire appeal type answer link`, () => {
  ...
  it(`Validate Listed Building questionnaire appeal type error validation`, () => {
	...
	it(`Validate Listed Building questionnaire changes a listed building validation`, () => {
	...
	// it(`Validate Listed Building questionnaire changes listed building or site has been added to the case validation`, () => {
	...
	it(`Validate Listed Building questionnaire Affects a listed building`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
	...
	// it(`Validate Listed Building questionnaire Affects Listed building or site has been added to the case validation`, () => {
	...
	it(`Validate Listed Building questionnaire Was a grant or loan made to preserve the listed building at the appeal site?`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
			.contains('Was a grant or loan made to preserve the listed building at the appeal site?')
			.closest(basePage?._selectors.govukSummaryListRow)
			.find(basePage?._selectors.agovukLink)
			.then(($link) => {
				const linkText = $link
					.text()
					.split('Was a grant or loan made to preserve the listed building at the appeal site?')[0]
					.trim();
				...
				if (linkText === 'Answer') {
					...
					cy.get(basePage?._selectors.govukErrorSummaryList)
						.find('a')
						.should('have.attr', 'href', '#section3aGrant')
						.and(
							'contain.text',
	...
	it(`Validate Listed Building questionnaire Did you consult Historic England?`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
			.contains('Did you consult Historic England?')
			.closest(basePage?._selectors.govukSummaryListRow)
			.find(basePage?._selectors.agovukLink)
			.then(($link) => {
				const linkText = $link
					.text()
					.split('Did you consult Historic England?')[0]
					.trim();
				...
				if (linkText === 'Answer') {
					...
					cy.get(basePage?._selectors.govukErrorSummaryList)
						.find('a')
						.should('have.attr', 'href', '#consultHistoricEngland')
						.and(
							'contain.text',
							'Select yes if you consulted Historic England'
						);
				} else if (linkText === 'Change') {
					cy.get(basePage?._selectors.govukSummaryListKey)
						.contains('Did you consult Historic England?')
				 ...
				 uploadDuplicateFiles(context);
				 //uploadFilesWithWrongFormats(context);
			});
			
	});

	it(`Validate Listed Building questionnaire Affects a scheduled monument validation`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
			.contains('Affects a scheduled monument')
			.closest(basePage?._selectors.govukSummaryListRow)
			.find(basePage?._selectors.agovukLink)
			.then(($link) => {
				const linkText = $link
					.text()
					.split('Would the development affect a scheduled monument?')[0]
					.trim();
				...
				if (linkText === 'Answer') {
					...
					cy.get(basePage?._selectors.govukErrorSummaryList)
						.find('a')
						.should('have.attr', 'href', '#affectsScheduledMonument')
						.and('contain.text', 'Select yes if the development would affect a scheduled monument');
				} else if (linkText === 'Change') {
					cy.get(basePage?._selectors.govukSummaryListKey)
						.contains('Affects a scheduled monument')
						.closest(basePage?._selectors.govukSummaryListRow)
	...
	it(`Validate Listed Building questionnaire Conversation Area`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
	...
	// it(`Validate Listed Building questionnaire Conservation area map and guidance`, () => {
	...
	it(`Validate Listed Building questionnaire affect a protected species validation`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
			...
			.then(($link) => {
				const linkText = $link
					.text()
					.split('Would the development affect a protected species?')[0]
					.trim();
				...
				if (linkText === 'Answer') {
					...
					cy.get(basePage?._selectors.govukErrorSummaryList)
						.find('a')
						.should('have.attr', 'href', '#protectedSpecies')
						.and('contain.text', 'Select yes if the development would affect a protected species');
				} else if (linkText === 'Change') {
					cy.get(basePage?._selectors.govukSummaryListKey)
						.contains('Protected species')
						.closest(basePage?._selectors.govukSummaryListRow)
	...
	it(`Validate Listed Building questionnaire Green Belt`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
			.contains('Green belt')
			.closest(basePage?._selectors.govukSummaryListRow)
			.find(basePage?._selectors.agovukLink)
	...
	it(`Validate Listed Building questionnaire Area of outstanding natural beauty`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
	...
	it(`Validate Listed Building questionnaire affect any designated sites`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
			...
			.then(($link) => {
				const linkText = $link
					.text()
					.split('Is the development in, near or likely to affect any designated sites?')[0]
					.trim();
				...
				if (linkText === 'Answer') {
					...
					cy.get(basePage?._selectors.govukErrorSummaryList)
						.find('a')
						.should('have.attr', 'href', '#designatedSites')
						.and(
							'contain.text',
	...
	it(`Validate Listed Building questionnaire Tree Preservation Order`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
	...
	// it(`Validate Listed Building questionnaire Tree Preservation Order extent`, () => {
	...
	it(`Validate Listed Building questionnaire Gypsy or Traveller`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
	...
	it(`Validate Listed Building questionnaire public right of way need to be removed or diverted`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
			.contains('Public right of way')
			.closest(basePage?._selectors.govukSummaryListRow)
			.find(basePage?._selectors.agovukLink)
			.then(($link) => {
				const linkText = $link
					.text()
					.split('Would a public right of way need to be removed or diverted?')[0]
					.trim();
				...
				if (linkText === 'Answer') {
					...
					cy.get(basePage?._selectors.govukErrorSummaryList)
						.find('a')
						.should('have.attr', 'href', '#publicRightOfWay')
						.and(
							'contain.text',
	...
	// it(`Validate Listed Building questionnaire Definitive map and statement extract`, () => {
  ...
  it(`Validate Listed Building questionnaire Did environmental statement`, () => {
	...
	it(`Validate Listed Building questionnaire Who was notified`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
	...
	it(`Validate Listed Building questionnaire Type of notification`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
	...
	// it(`Validate Listed Building questionnaire Uploaded site notice`, () => {
	...
	// it(`Validate Listed Building questionnaire Letter sent to neighbours`, () => {
	...
	it(`Validate Listed Building questionnaire Statutory consultees`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
			.contains('Statutory consultees')
			.closest(basePage?._selectors.govukSummaryListRow)
			.find(basePage?._selectors.agovukLink)
			.then(($link) => {
				const linkText = $link
					.text()
					.split('Did you consult all the relevant statutory consultees about the development?')[0]
					.trim();
				...
				if (linkText === 'Answer') {
					...
					cy.get(basePage?._selectors.govukErrorSummaryList)
						.find('a')
						.should('have.attr', 'href', '#statutoryConsultees')
						.and(
							'contain.text',
	...
	// it(`Validate Listed Building questionnaire Responses or standing advice to upload`, () => {
	...
	it(`Validate Listed Building questionnaire Upload the consultation responses and standing advice`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
	...
	it(`Validate Listed Building questionnaire Representations from other parties`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
	...
	// it(`Validate Listed Building questionnaire Upload representations from other parties`, () => {
	...
	it(`Validate Listed Building questionnaire Upload planning officer’s report`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
			.contains('Upload planning officer’s report')
			.closest(basePage?._selectors.govukSummaryListRow)
			.find(basePage?._selectors.agovukLink)
			.then(($link) => {
				const linkText = $link
  ...
  it(`Validate Listed Building questionnaire Policies from statutory development plan`, () => {
	...
	it(`Validate Listed Building questionnaire Emerging plans`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
	...
	// it(`Validate Listed Building questionnaire Upload emerging plan and supporting information`, () => {
  ...
  it(`Validate Listed Building questionnaire Upload any other relevant policies`, () => {
	...
	it(`Validate Listed Building questionnaire Supplementary planning documents`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
	...
	// it(`Validate Listed Building questionnaire Upload supplementary planning documents`, () => {
	...
	it(`Validate Listed Building questionnaire Community infrastructure levy`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
			.contains('Community infrastructure levy')
			.closest(basePage?._selectors.govukSummaryListRow)
			.find(basePage?._selectors.agovukLink)
			.then(($link) => {
				const linkText = $link
					.text()
					.split('Do you have a community infrastructure levy?')[0]
					.trim();
				...
				if (linkText === 'Answer') {
					...
					cy.get(basePage?._selectors.govukErrorSummaryList)
						.find('a')
						.should('have.attr', 'href', '#infrastructureLevy')
						.and('contain.text', 'Select yes if you have a community infrastructure levy');
				} else if (linkText === 'Change') {
					cy.get(basePage?._selectors.govukSummaryListKey)
						.contains('Community infrastructure levy')
						.closest(basePage?._selectors.govukSummaryListRow)
	...
	//  6. Site access
	it(`Validate Listed Building questionnaire Access for inspection`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
	...
	it(`Validate Listed Building questionnaire Might the inspector need to enter a neighbour’s land or property?`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
	...
	it(`Validate Listed Building questionnaire Potential safety risks`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
	...
	it(`Validate Listed Building questionnaire Procedure type`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
			.contains('Procedure type')
			.closest(basePage?._selectors.govukSummaryListRow)
			.find(basePage?._selectors.agovukLink)
			.then(($link) => {
				const linkText = $link
				...
				if (linkText === 'Answer') {
					...
					cy.get(basePage?._selectors.govukErrorSummaryList)
						.find('a')
						.should('have.attr', 'href', '#lpaProcedurePreference')
						.and('contain.text', 'Select the most appropriate procedure');
				} else if (linkText === 'Change') {
					cy.get(basePage?._selectors.govukSummaryListKey)
						.contains('Procedure type')
						.closest(basePage?._selectors.govukSummaryListRow)
	...
	it(`Validate Listed Building questionnaire Appeals near the site`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
	...
	//// Commented to implement partially completed questionnaire validations later
	// it(`Validate Listed Building questionnaire Other appeal`, () => {
	...
	it(`Validate Listed Building questionnaire Extra conditions`, () => {
		cy.get(basePage?._selectors.govukSummaryListKey)
			.contains('Extra conditions')
			.closest(basePage?._selectors.govukSummaryListRow)
			.find(basePage?._selectors.agovukLink)
			.then(($link) => {
	...
	// it(`Validate Listed Building questionnaire Submit`, () => {
	//   cy.get(basePage?._selectors.govukSummaryListKey).contains('Appeals near the site').closest(basePage?._selectors.govukSummaryListRow).find(basePage?._selectors.agovukLink).then(($link) => {
	//     const linkText = $link.text().split('Add new planning conditions to this appeal')[0].trim();
	//
	//     if (linkText === 'Answer') {
