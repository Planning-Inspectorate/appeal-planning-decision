...
describe('Rule 6 Proof of Evidence Validations', () => {
    ...
    it(`Validate user should not be allowed to upload wrong format file`, () => {
        cy.uploadFileFromFixtureDirectory(r6FullAppealsProofsOfEvidenceTestCases[0]?.documents?.uploadWrongFormatFile);
        cy.advanceToNextPage();
        cy.shouldHaveErrorMessage('a[href*="#uploadRule6ProofOfEvidenceDocuments"]', `${r6FullAppealsProofsOfEvidenceTestCases[0]?.documents?.uploadWrongFormatFile} must be a DOC, DOCX, PDF, TIF, JPG or PNG`);
    });
    ...
    it(`Validate user should not be allowed to upload wrong format file for Upload your witnesses and their evidence`, () => {
        ...
        cy.uploadFileFromFixtureDirectory(r6FullAppealsProofsOfEvidenceTestCases[0]?.documents?.uploadWrongFormatFile);
        cy.advanceToNextPage();
        cy.shouldHaveErrorMessage('a[href*="#uploadRule6WitnessesEvidence"]', `${r6FullAppealsProofsOfEvidenceTestCases[0]?.documents?.uploadWrongFormatFile} must be a DOC, DOCX, PDF, TIF, JPG or PNG`);
    });
    ...
    //     cy.uploadFileFromFixtureDirectory(r6FullAppealsProofsOfEvidenceTestCases[0]?.documents?.uploadFileGreaterThan25mb);
    //     cy.advanceToNextPage();
    //     cy.shouldHaveErrorMessage('a[href*="#uploadRule6WitnessesEvidence"]', `${r6FullAppealsProofsOfEvidenceTestCases[0]?.documents?.uploadFileGreaterThan25mb} must be smaller than 25MB`);
    // }); 
