...
import { ldcAppealRefusedTestCases } from "../../../helpers/appellantAAPD/ldcAppeal/ldcAppealRefusedData";
...
describe('Submit Full Appeal Refused Test cases', { tags: '@LDC-refused' }, () => {
	...
	ldcAppealRefusedTestCases.forEach((context) => {
		const {
