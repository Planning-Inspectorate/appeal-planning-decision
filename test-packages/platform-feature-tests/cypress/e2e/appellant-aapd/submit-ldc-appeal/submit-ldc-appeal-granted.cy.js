...
describe('Submit LDC Appeal Granted Test cases', { tags: '@LDC-granted' }, () => {
	...
	// Iterate through each test case in the ldcAppealGrantedTestCases array
	ldcAppealGrantedTestCases.forEach((context) => {
		const {
