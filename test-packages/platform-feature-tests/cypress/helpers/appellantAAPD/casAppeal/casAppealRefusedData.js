...
export const casAppealRefusedTestCases = [
    {
        ...
        applicationForm: {
            ...
            //isAgriculturalHolding: false, --not for CAS
            //isTenantAgricultureHolding : true,--not for CAS
            anyOtherTenants: true,
            //majorMionorDevelopmentData: 'major',//---cas appeal not this question--
            //applicationAboutData: '',//---cas appeal not this question
            isInspectorNeedAccess: true,
            isAppellantSiteSafety: true,
            isUpdateDevelopmentDescription: true,
            islocalPlanningChanged:true,//addedd for cas
