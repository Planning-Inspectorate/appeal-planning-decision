...
export class PoReportAndSupportDocs {
    ...
    selectPOReportAndSupportDocsS78(context) {
        const basePage = new BasePage();
        cy.uploadFileFromFixtureDirectories('decision-letter.pdf');//Upload the planning officer’s report or what your decision notice would have said
        cy.advanceToNextPage();
        cy.uploadFileFromFixtureDirectories('decision-letter.pdf');//Upload relevant policies from your statutory development plan
        cy.advanceToNextPage();
    };        
