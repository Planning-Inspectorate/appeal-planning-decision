...
export class SiteAreaPage {
    ...
    addSiteAreaData(applicationType, areaUnits, context, prepareAppealData) {
        ...
        if ((applicationType === 'answer-householder-planning' && context?.statusOfOriginalApplication === 'refused') || (applicationType === 'answer-minor-commercial-development'  && context?.selectAllPlanningApplicationAbout === false && context?.statusOfOriginalApplication === 'refused' )) {
