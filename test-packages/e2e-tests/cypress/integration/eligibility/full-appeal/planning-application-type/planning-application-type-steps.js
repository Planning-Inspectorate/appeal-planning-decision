...
Then(
	'appellant is navigated to the is your planning application about any of the following page',
	() => {
...
Then(
	'an appellant is navigated to the what local planning department did you submit your application to page',
	() => {
...
Then(
	'appellant is presented with the page Did you apply for prior approval to extend an existing home?',
	() => {
