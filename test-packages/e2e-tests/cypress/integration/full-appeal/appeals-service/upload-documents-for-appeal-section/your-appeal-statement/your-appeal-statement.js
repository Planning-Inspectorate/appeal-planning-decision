...
When(
	"select the checkbox 'I confirm that I have not included any sensitive information in my appeal statement'",
	() => {
...
Given(
	'an appellant has not ticked the box to confirm they have not included any sensitive information',
	() => {
		appealDocumentsSectionLink().click();
...
Given(
	'an appellant has not uploaded any document or ticked the box to confirm they have not included any sensitive information',
	() => {
		appealDocumentsSectionLink().click();
		getSaveAndContinueButton().click();
	}
...
Given(
	"an appellant is on the 'Your appeal statement' page and have uploaded a valid file {string}",
	(filename) => {
		appealDocumentsSectionLink().click();
		getFileUploadButton().attachFile(filename);
		checkboxConfirmSensitiveInfo().click();
