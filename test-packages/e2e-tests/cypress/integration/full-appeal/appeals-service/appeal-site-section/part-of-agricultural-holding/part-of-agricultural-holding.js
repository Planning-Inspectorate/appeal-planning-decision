...
const pageTitleAgriculturalHolding =
...
Given(
	"an appellant or agent is on the 'Do you own all of the land involved in the appeal' page",
	() => {
		aboutAppealSiteSectionLink().click();
		cy.url().should('contain', siteAddressUrl);
		provideAddressLine1(addressLine1);
...
Then(
	"'Is the appeal site part of an agricultural holding' page is displayed with some guidance text",
	() => {
...
Given(
	"an appellant or agent is on the {string} page for the journey OwnSomeOfLand as 'Yes' and {string}",
...
Given(
	"an appellant or agent is on the {string} page for the journey OwnSomeOfLand as 'No' and {string}",
	(CurrentPage, KnowTheOwners) => {
		switch (KnowTheOwners) {
			case 'Yes, I know who owns all the land':
