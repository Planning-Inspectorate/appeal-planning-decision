...
const pageTitle =
	'How many days would you expect the inquiry to last? - Appeal a planning decision - GOV.UK';
...
Given(
	"an Appellant or Agent is on the 'How many days would you expect the inquiry to last?' page",
	() => {
		cy.url().should('include', taskListUrl);
		linkDecideYourAppeal().click();
		selectInquiry().click();
...
Then(
	'they are presented with an error message {string} in the expect inquiry last page',
	(errormessage) => {
