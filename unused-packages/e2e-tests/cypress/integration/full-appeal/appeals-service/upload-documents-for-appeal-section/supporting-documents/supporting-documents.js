...
Then(
	"'Do you want to submit any new supporting documents with your appeal?' page is displayed",
	() => {
...
Then(
	"they are presented with the 'New plans or drawings' page and the No option is selected",
	() => {
		cy.url().should('contain', plansDrawingsUrl);
