...
const pageTitle =
	'Do you own some of the land involved in the appeal? - Appeal a planning decision - GOV.UK';
...
Given(
	"an appellant or agent is on the 'Do you own all the land involved in the appeal' page",
	() => {
...
Then(
	"the user is taken to the next page 'Do you know who owns the rest of the land involved in the appeal?'",
	() => {
		cy.url().should('contain', knowTheOwnersUrl);
	}
);
Then(
	"the user is taken to the next page 'Do you know who owns the land involved in the appeal'",
	() => {
		cy.url().should('contain', knowTheOwnersUrl);
	}
);
