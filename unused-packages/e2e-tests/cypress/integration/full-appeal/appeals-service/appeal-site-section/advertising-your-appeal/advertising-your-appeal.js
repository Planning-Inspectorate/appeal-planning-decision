...
import {
	...
	advertisingYourAppealForKnowSomeOfTheLandownersText,
	advertisingYourAppealForKnowSomeOfTheOtherLandownersText,
...
Given(
	'an appellant is on the Do you know who owns the land involved in the appeal page for {string}',
	(landowners) => {
...
Given(
	'an appellant or agent is on the Advertising your appeal page for the {string} and {string}',
...
Then(
	'advertising your appeal page is displayed with guidance text for {string} and {string}',
	(landowners, knowTheOwners) => {
		cy.url().should('contain', url);
		verifyPageTitle(pageTitle);
		verifyPageHeading(pageHeading);
		...
		if (
			landowners === 'Telling the landowners' &&
			knowTheOwners === 'No, I do not know who owns any of the land'
		) {
			advertisingYourAppealForKnowNoneOfTheLandownersText().should('exist');
		} else if (
			landowners === 'Telling the landowners' &&
			knowTheOwners === 'I know who owns some of the land'
		) {
			advertisingYourAppealForKnowSomeOfTheLandownersText().should('exist');
		} else if (
			landowners === 'Telling the other landowners' &&
			knowTheOwners === 'No, I do not know who owns any of the land'
		) {
