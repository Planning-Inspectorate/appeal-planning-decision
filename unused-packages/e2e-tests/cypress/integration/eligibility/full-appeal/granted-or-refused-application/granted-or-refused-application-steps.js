...
Then(
	'appellant gets navigated to the What’s the decision date on the letter from the local planning department?',
	() => {
...
Then(
	'the appellant is navigated to Was your planning application about any of the following?',
	() => {
