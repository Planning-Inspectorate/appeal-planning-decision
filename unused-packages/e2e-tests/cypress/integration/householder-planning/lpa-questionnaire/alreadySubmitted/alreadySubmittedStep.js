...
When(
	'the LPA Planning Officer is trying to access {string} of already submitted questionnaire',
	(page) => {
...
Then('the Already Submitted page should have Enquiries Email link', () => {
	enquiriesEmailLink().should('have.attr', 'href', 'mailto:enquiries@planninginspectorate.gov.uk');
});
