...
export const getAcceptAnalyticsCookies = () =>
	cy.get('[data-cy=cookie-banner-accept-analytics-cookies]');
export const getCookiesBannerAcceptedHideMessage = () =>
	cy.get('[data-cy=cookie-banner-accepted-hide-message]');
...
export const privacyNoticeLink = () =>
	cy.findAllByText('Privacy Notice').should('have.attr', 'href');
export const termAndConditionsLink = () =>
	cy.findAllByText('Terms and Conditions').should('have.attr', 'href');
...
export const errorMessageConditionsHouseholder = () =>
	cy.get('#conditions-householder-permission-error');
