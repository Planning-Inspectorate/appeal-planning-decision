...
Then('a case is created for a case officer', () => {
  ...
  cy.task('getLastFromQueue').then((actualMessage) => {
    ...
    delete expectedNoDynamicFields.appeal.submissionDate;
    ...
    delete expectedNoDynamicFields.appeal.requiredDocumentsSection.decisionLetter.uploadedFile
      .location;
    ...
    delete actualNoDynamicFields.appeal.submissionDate;
    ...
    delete actualNoDynamicFields.appeal.requiredDocumentsSection.originalApplication.uploadedFile
      .id;
    delete actualNoDynamicFields.appeal.requiredDocumentsSection.originalApplication.uploadedFile
      .location;
    delete actualNoDynamicFields.appeal.requiredDocumentsSection.decisionLetter.uploadedFile.id;
    delete actualNoDynamicFields.appeal.requiredDocumentsSection.decisionLetter.uploadedFile
      .location;
