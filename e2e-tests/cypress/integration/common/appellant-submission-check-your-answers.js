...
Then('the appeal information is presented', () => {
  ...
  cy.confirmCheckYourAnswersDisplayItem('[data-cy="upload-application"]', 'appeal-statement-valid.doc');
  cy.confirmCheckYourAnswersDisplayItem('[data-cy="upload-decision"]', 'appeal-statement-valid.doc');
  cy.confirmCheckYourAnswersDisplayItem('[data-cy="appeal-statement"]', 'appeal-statement-valid.doc');
  cy.confirmCheckYourAnswersDisplayItem('[data-cy="supporting-documents-no-files"]', 'No files uploaded');
  cy.confirmCheckYourAnswersDisplayItem('[data-cy="site-location"]', '1 Taylor Road\nClifton\nBristol\nSouth Glos\nBS8 1TG');
...
Then('the updated values for About you section are displayed', () => {
  ...
  cy.confirmCheckYourAnswersDisplayItem('[data-cy="appealing-on-behalf-of"]', 'New Original Applicant');
});
...
Then('the updated values for About the original planning application section are displayed', () => {
  ...
  cy.confirmCheckYourAnswersDisplayItem('[data-cy="upload-application"]', 'appeal-statement-valid.jpeg');
  cy.confirmCheckYourAnswersDisplayItem('[data-cy="upload-decision"]', 'appeal-statement-valid.pdf');
});
...
Then('the updated values for About your appeal section are displayed', () => {
  cy.confirmCheckYourAnswersDisplayItem('[data-cy="appeal-statement"]', 'appeal-statement-valid.png');
  cy.confirmCheckYourAnswersDisplayItem('[data-cy="supporting-documents-no-files"]', 'No files uploaded');
});
...
Then('the updated values for Visiting the appeal site section are displayed', () => {
  cy.confirmCheckYourAnswersDisplayItem('[data-cy="site-location"]', 'New 1 Taylor Road\nNew Clifton\nNew Bristol\nNew South Glos\nXX8 1XX');
...
Then('the multiple other documents are correctly displayed', () => {
  cy.confirmCheckYourAnswersDisplayItem('[data-cy="supporting-documents-uploaded-file-count-heading"]', '3 files uploaded');
  cy.confirmCheckYourAnswersDisplayItem('[data-cy="supporting-documents-uploaded-file-0"]', 'appeal-statement-valid.pdf');
  cy.confirmCheckYourAnswersDisplayItem('[data-cy="supporting-documents-uploaded-file-1"]', 'appeal-statement-valid.docx');
  cy.confirmCheckYourAnswersDisplayItem('[data-cy="supporting-documents-uploaded-file-2"]', 'appeal-statement-valid.doc');
});
