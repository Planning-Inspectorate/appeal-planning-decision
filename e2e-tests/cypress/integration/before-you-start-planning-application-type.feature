Feature: Planning Application Type
  ...
  Scenario Outline:AC02: Appellant selects application type other that house holder planning
    ...
    And appellant clicks on the continue button
    Then appellant gets navigated to the is your planning application about any of the following page
  Examples:
  ...
  Scenario: AC04 - Back link
    Given an appellant is on the select the type planning application you made page
    When an appellant  selects the back button
    Then an appellant is taken back to the what local planning department did you submit your application to page
  ...
  Scenario Outline:AC05 - Appellants selects Something else or I have Not Made An Appeal
    Given an appellant is on the select the type planning application you made page
    When an appellant selects '<invalid_planning_type>' a planning application
